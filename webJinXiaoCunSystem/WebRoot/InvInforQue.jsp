...
<body>
		...
		<div class="row">
			<div class="col-lg-12">
<form action="InvInforQue.jsp" method="post">
查询商品名：
<input type="text" value="" name="findproname"/>
<input type="submit" value="搜索"/>
		...
		String proname ="";
		try{
			proname = request.getParameter("findproname");
 		}catch(Exception e){
 		proname="";
 		}
 		if(proname==null){
 		proname="";
			...
			List<Enterstock> esList =new ArrayList<Enterstock>();
						esList=esBiz.findAllByProName(proname);
						if(esList!=null)
