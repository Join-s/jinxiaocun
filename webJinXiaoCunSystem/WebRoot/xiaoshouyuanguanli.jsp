		...
		<script  type="text/javascript">
			$(function(){
				...
				$(".updateUser").click(function(){
					...
					var input4 = $("<input type='text' name='type' value='1' />");
...
<form action="addUsers" method="post">
			...
			<%
				...
				sumPage=uBiz.getCountsOfRow("1",row);
			...
			ulist=uBiz.findAll("1", curPage, row);
			if(ulist!=null)
			...
			<tr>
				...
				<td><input type="text"
					value='<%=u.getPsw()%> ' /></td>
				<td><input type="text"
					value='<%=u.getType().equals("1")?"销售员":""%>'  readonly="readonly" /></td>
				<td><input type="text"
			...
			<tr >
				<td colspan="7" align="right" style="text-align: right;">
							当前页数:[<%=curPage %>/<%=sumPage %>]&nbsp;&nbsp;
								<a href="xiaoshouyuanguanli.jsp?curPage=1">首页</a> &nbsp;&nbsp;
								<a href="xiaoshouyuanguanli.jsp?curPage=<%=curPage-1 %>">上一页</a>&nbsp;&nbsp;
								<a href="xiaoshouyuanguanli.jsp?curPage=<%=curPage+1 %>">下一页</a>&nbsp;&nbsp;
								<a href="xiaoshouyuanguanli.jsp?curPage=<%=sumPage %>">尾页</a>&nbsp;&nbsp;
				</td>
			</tr>
		</table></div></div></div>
</body>
